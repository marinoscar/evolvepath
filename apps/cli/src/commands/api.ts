...
// =============================================================================
// `evopath api <method> <path>`  (issue #144, epic #110)
// =============================================================================
//
 ...
 * local error rather than a confusing remote one. `evopath api GTE /api/users`
...
async function runApiCommand(
  ...
  // EVOPATH_SERVER_URL / EVOPATH_TOKEN pair, which #143 resolves together.
 ...
 * `evopath api GET api/users` produces `https://host/apiapi/users` or a 404
