...
@Module({
  ...
  controllers: [WorkoutProgramsController, ExercisesController],
  providers: [ExerciseResolverService, WorkoutProgramGeneratorService, WorkoutProgramsService],
  exports: [WorkoutProgramsService, ExerciseResolverService],
})
