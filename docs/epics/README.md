...
|---|---|---|---|---|---|
| E01 | 1 · Foundation | AI Provider Configuration & Bring-Your-Own-Key | Admin configures OpenAI (platform key, per-persona models from a live catalog filtered to GPT ≥ 5.4, test connection); every user brings their own encrypted key, gated at first login; one `AiGatewayService` every later feature calls. | §14, §88, §115, §117, §118, §120 | _pending_ |
| E02 | 1 · Foundation | Product Shell, Domain Model & Path Screen | Deterministic state before AI: Best Self, Outcomes, versioned Plans, Routines, Commitments, Evidence; the five-tab navigation (Today/Path/Coach/Progress/Profile); PWA basics. | §9, §10, §11, §80, §103, §123 | _pending_ |
| E03 | 1 · Foundation | Media Attachments for AI Advice | Photos and videos uploadable from the phone camera, MIME/size enforcement, server-side video frame sampling, attachable to AI calls. | §46, user requirement | _pending_ |
| E04 | 2 · Core loop | Onboarding: Best Self → First Path | AI-assisted 5–8 minute onboarding producing a persisted, approved first plan; coaching style; time reality. | §19–§21, §43–§44, §70–§72, §102 | _pending_ |
| E05 | 2 · Core loop | Today Screen, Commitments Lifecycle & Start Flow | Deterministic next-best-action engine, domain cards, Start/Continue/Fallback/Reschedule/Skip, daily check-in, evidence. | §12, §13, §27, §28, §73, §74 | _pending_ |
| E06 | 2 · Core loop | AI Coach: Context Assembler, Coaching Reasoner, Mutation Protocol & Memory | Coach screen, structured proposals with diff/approve, memory insights under user control, safety layer. | §14.1–14.3, §14.8, §15–§18, §66–§68, §85 | _pending_ |
| E07 | 3 · Domains | Work Domain: Focus Sessions & Anti-Procrastination | Focus timer, decomposition, avoidance detection, intervention ladder. | §22–§29, §104 | _pending_ |
| E08 | 3 · Domains | Family Domain: Commitments & Rituals | Recurring rituals, minimal family-member records, presence cues, no scoring. | §30–§35, §105 | _pending_ |
| E09 | 3 · Domains | Health Domain: Workout Programs, Runner & Media Coaching | AI program builder (structured), persistence, runner with logging, progression rules, fallbacks, video form-check and photo advice, nutrition behaviours, optional weight trend. | §36–§47, §106 | _pending_ |
| E10 | 4 · Adaptation | Weekly Review & Weekly Planning | Planned-vs-actual, Weekly Review Reasoner, plan diffs → new plan version, domain modes, cross-domain load check. | §48–§51, §14.6 | _pending_ |
| E11 | 4 · Adaptation | Momentum, Progress & Recovery | Deterministic momentum states, evidence timeline, consistency runs, comeback loop, no catch-up debt, celebrations. | §52–§57, §75–§77, §109 | _pending_ |
| E12 | 4 · Adaptation | Coaching Notifications | Deterministic decision engine (quiet hours, caps, fatigue), categories N1–N9, AI copy generator, deep-link actions, independence metric. | §58–§65, §14.7, §108 | _pending_ |
